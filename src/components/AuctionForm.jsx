...
// import { Form, Input, InputNumber, Button, Card, message, Descriptions } from "antd";
...
//         durationInHours: Math.floor(values.durationInHours) // whole hours for validation safety
//       };
...
//       <ThunderboltOutlined className="glowy-icon" />
//       <Card title="Create Auction Item" className="mb-6 shadow-lg">
